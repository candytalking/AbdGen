...
def create_mario_dataset(folder):
    ...
    position_set = set()
    position_set.add(((0,0),(0,1),(0,2),(1,2),(2,2)))
    position_set.add(((1,0),(1,1),(2,1),(2,2)))
    position_set.add(((2,0),(2,1),(2,2)))
    position_set.add(((1,0),(1,1),(1,2)))
    position_set.add(((1,1),(1,2),(2,2)))
    position_set.add(((0,1),(0,2),(1,2)))
    position_set.add(((2,1),(1,1),(1,2)))
    ...
    for dataset in ['all']:
        np.savez(os.path.join(folder, f'{dataset}_mario_neg.npz'), images=images[dataset],
